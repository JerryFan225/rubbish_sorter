...
detectnet --model=/home/nvidia/rubbish_sorter/models/ssd-mobilenet.onnx --labels=/home/nvidia/rubbish_sorter/models/labels.txt --input-blob=input_0 --output-cvg=scores --output-bbox=boxes --colors=/home/nvidia/rubbish_sorter/models/colours.txt /dev/video0
